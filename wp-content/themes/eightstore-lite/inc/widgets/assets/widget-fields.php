 ...
 * @package 8Store Lite
 */
function eightstore_lite_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    // Store Posts in array
    $eightstore_lite_postlist[0] = array(
        'value' => 0,
        'label' => '--choose--'
        );
    $arg = array('posts_per_page' => -1);
    $eightstore_lite_posts = get_posts($arg);
    foreach ($eightstore_lite_posts as $eightstore_lite_post) :
        $eightstore_lite_postlist[$eightstore_lite_post->ID] = array(
            'value' => $eightstore_lite_post->ID,
            'label' => $eightstore_lite_post->post_title
            );
    endforeach;

    extract($widget_field);

    switch ($eightstore_lite_widgets_field_type) {

        // Standard text field
        case 'text' :
        ?>
        <p>
            <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?>:</label>
            <input class="widefat" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" type="text" value="<?php echo esc_attr($athm_field_value) ; ?>" />

            <?php if (isset($eightstore_lite_widgets_description)) { ?>
            <br />
            <small><?php echo $eightstore_lite_widgets_description; ?></small>
            <?php } ?>
        </p>
        <?php
        break;
        ...
        case 'group_start' :
        ?>
        <div class="main-group" id="ap-font-awesome-list <?php echo $instance->get_field_id(($eightstore_lite_widgets_name)); ?>">
            <div class="main-group-heading"><?php echo $eightstore_lite_widgets_title ; ?><span class="toogle-arrow"></span></div>
        ...
        // Standard url field
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?>:</label>
                <input class="widefat" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />
        ...
        // Textarea field
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?>:</label>
                <textarea class="widefat" rows="<?php echo $eightstore_lite_widgets_row; ?>" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
            </p>
            <?php
            break;
        ...
        // Checkbox field
            ...
            ?>
            <p>
                <input id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?></label>
        ...
        // Radio fields
            ...
            <p>
                <?php
                echo $eightstore_lite_widgets_title;
                echo '<br />';
                foreach ($eightstore_lite_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        // Select field
                ...
                <p>
                    <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?>:</label>
                    <select name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" class="widefat">
                        <?php foreach ($eightstore_lite_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
                ...
                ?>
                <p>
                    <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?>:</label><br />
                    <input name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" type="number" step="4" min="4" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
        ...
        // Select field
                ...
                <p>
                    <label for="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>"><?php echo $eightstore_lite_widgets_title; ?>:</label>
                    <select name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" class="widefat">
                        <?php foreach ($eightstore_lite_postlist as $eightstore_lite_single_post) { ?>
                        <option value="<?php echo $eightstore_lite_single_post['value']; ?>" id="<?php echo $instance->get_field_id($eightstore_lite_single_post['label']); ?>" <?php selected($eightstore_lite_single_post['value'], $athm_field_value); ?>><?php echo $eightstore_lite_single_post['label']; ?></option>
                        <?php } ?>
                    </select>
                ...
                $output = '';
                $id = $instance->get_field_id($eightstore_lite_widgets_name);
                $class = '';
                $int = '';
                $value = $athm_field_value;
                $name = $instance->get_field_name($eightstore_lite_widgets_name);
                ...
                $output .= '<label for="'.$instance->get_field_id($eightstore_lite_widgets_name).'">'.$eightstore_lite_widgets_title.'</label><br/>';
                $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'eightstore-lite') . '" />' . "\n";
                if (function_exists('wp_enqueue_media')) {
                    if (( $value == '')) {
                        $output .= '<input id="upload-' . $id . '" class="upload-button-wdgt button" type="button" value="' . __('Upload', 'eightstore-lite') . '" />' . "\n";
                    } else {
                        $output .= '<input id="remove-' . $id . '" class="remove-file button" type="button" value="' . __('Remove', 'eightstore-lite') . '" />' . "\n";
                    }
                } else {
                    $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'eightstore-lite') . '</i></p>';
                }
                ...
                if ($value != '') {
                    ...
                    // Standard generic output if it's not an image.
                        $title = __('View File', 'eightstore-lite');
                ...
                <p>
                    ...
                    <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($eightstore_lite_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($eightstore_lite_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
        ...
        function eightstore_lite_widgets_updated_field_value($widget_field, $new_field_value) {

            extract($widget_field);

    // Allow only integers in number fields
            if ($eightstore_lite_widgets_field_type == 'number') {
                return absint($new_field_value);

        // Allow some tags in textareas
            } elseif ($eightstore_lite_widgets_field_type == 'textarea') {
        // Check if field array specifed allowed tags
                if (!isset($eightstore_lite_widgets_allowed_tags)) {
            // If not, fallback to default tags
                    $eightstore_lite_widgets_allowed_tags = '<p><strong><em><a>';
                }

                return strip_tags($new_field_value, $eightstore_lite_widgets_allowed_tags);

        // No allowed tags for all other fields
            } elseif ($eightstore_lite_widgets_field_type == 'iframe_textarea') {
        // Check if field array specifed allowed tags
                if (!isset($eightstore_lite_widgets_allowed_tags)) {
            // If not, fallback to default tags
                    $eightstore_lite_widgets_allowed_tags = '<iframe>';
                }
        ...
        // No allowed tags for all other fields
            ...
            elseif ($eightstore_lite_widgets_field_type == 'url') {
                return esc_url_raw($new_field_value);
            }
            elseif ($eightstore_lite_widgets_field_type == 'title') {
 ...
 */
function widgets_media_scripts($hook) {
    if ( 'customize.php' == $hook || 'widgets.php' == $hook ) {
        if (function_exists('wp_enqueue_media'))
            wp_enqueue_media();

        wp_register_script('of-media-uploader', get_template_directory_uri() . '/inc/widgets/js/media-uploader.js', array('jquery'), 1.70);
        wp_enqueue_script('of-media-uploader');
        wp_localize_script('of-media-uploader', 'eightstore_lite_optionsframework_l10n', array(
            'upload' => __('Upload', 'eightstore-lite'),
            'remove' => __('Remove', 'eightstore-lite')
            ));

        wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css' );
        wp_enqueue_style( 'eightstore-admin-control', get_template_directory_uri() . '/inc/css/admin-control.css' );
        wp_enqueue_script('eightstore-admin-control', get_template_directory_uri() . '/inc/js/admin-control.js', array('jquery'));
    }
    else{
        return;
    }
...
add_action('admin_enqueue_scripts', 'widgets_media_scripts');
endif;