...
* [FAQ Google Maps](http://huge-it.com/wordpress-google-map-faq/)
* [User Manual Google Maps](http://huge-it.com/wordpress-google-map-user-manual/)
...
3. Upload [WordPress Google Maps](http://wordpress.org/plugins/google-maps). 
...
13.  [WordPress Google Maps](http://huge-it.com/google-map/) - Google Maps Marker
...
In order to install pro version of the plugin, simply follow these steps: 1) delete your free version of plugin 2) install the zip file | Plugins > add new > upload plugin3) clean your cache files |ctrl+f5| Don’t be afraid of deleting free version, because you will NOT lose your created maps
...
= 2.0.2 =
*  Mirror bug fixed in Google Maps.

= 2.0.1 =
*  Front end bug fixed.

= 2.0.0 =
*  Global Update Google Maps.
